...
class CharacterCreationStateView extends BaseStateView {
    ...
    for(var i=0; i< races.length; i++ ) {
      ...
      var btn = new ButtonView("btnRace", "gfx/btn_white_sm.sprite", rname, "12px Arial", "#000000", {idx:i});
    ...
    for(var i=0; i< classes.length; i++ ) {
      ...
      var btn = new ButtonView("btnClass", "gfx/btn_white_sm.sprite", cname, "12px Arial", "#000000", {idx:i});
