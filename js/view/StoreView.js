...
class StoreConfirmView extends NodeView {
    constructor(isSelling, itemModel) {
        ...
        var btnConfirm = new ButtonView(confirmEvt, "gfx/btn_blue.sprite", confirmText, "20px Arial", "#FFFFFF");
        btnConfirm.pos.setVal(75, 75);
        this.addChild(btnConfirm);

        var btnCancel = new ButtonView("btnCancelConfirm", "gfx/btn_blue.sprite", "Cancel", "20px Arial", "#FFFFFF");
