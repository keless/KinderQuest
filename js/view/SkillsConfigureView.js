...
class SkillsConfigureView extends NodeView {
    ...
    this.btnReset = new ButtonView("btnResetSkills", "gfx/btn_blue.sprite", "Reset All");
    this.btnReset.pos.setVal(screenSize.x/2 - 100, 80);
    this.addChild(this.btnReset);

    var btnClose = new ButtonView("btnCloseSkills", "gfx/btn_blue.sprite", "Done");
    ...
    for(var i=0; i < treeKeys.length; i++) {
      ...
      var btn = new ButtonView("tabTree", "gfx/btn_white.sprite", tree.name, "14px Arial", "#000000", {idx:i});
  ...
  updateChosenAbilities() {
    ...
    for(var i=0; i < skillModel.chosen.length; i++) {
      ...
      var abilityNode = new ButtonView("btnSkillEquip", "gfx/btn_white.sprite", abilityName, "14px Arial", "#000000", {abilityId:abilityId, x:pos.x, y:pos.y });
...
class AbilityInfoView extends NodeView {
  constructor( abilityId, rank ) {
    ...
    var btnClose = new ButtonView("btnCloseAbilityView", "gfx/btn_white_sm.sprite", "X", "18px Arial", "#FF0000");
  ...
  addUnequipView( abilityId, offset ) {
    ...
    var btnUnequip = new ButtonView("btnUnequipSkill", "gfx/btn_white.sprite", "Remove", null, "#000000", {abilityId:abilityId});
  ...
  addEquipView( abilityId, offset ) {
    ...
    var btnUnequip = new ButtonView("btnEquipSkill", "gfx/btn_white.sprite", "Choose", null, "#000000", {abilityId:abilityId});
    btnUnequip.pos.x += 20;
    view.addChild(btnUnequip);

    var btnUp = new ButtonView("btnSkillUp", "gfx/btn_white_sm.sprite", "+", null, "#000000", {abilityId:abilityId});
    btnUp.pos.x -= 70;
    view.addChild(btnUp);
