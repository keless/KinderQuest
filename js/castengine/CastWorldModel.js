...
class CastWorldModel {
	...
	AddEntity( entity ) {
		if(entity.uuid in this.m_allEntities) {
			console.warn("assigning entity over existing entity");
		}
		this.m_allEntities[ entity.uuid ] = entity;
	}
	
	RemoveEntity( entity ) { 
		if(entity.uuid in this.m_allEntities) {
			delete this.m_allEntities[entity.uuid];
		}
	}
	...
	//bool
	isValid( entity ) {
		if(entity.uuid in this.m_allEntities) return true;
		return false;
	}
